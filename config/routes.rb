Rails.application.routes.draw do
 ...
 :sessions => 'users/sessions'
  ...
  get "/posts/:dictionary_id/:id/",         to: "posts#show", as: 'posts_show'
	get "/posts/:dictionary_id/:id/edit",     to: "posts#edit"
  post "/posts/create",                     to: "posts#create"
  patch "/posts/:dictionary_id/:id/",       to: "posts#update"
  ...
  patch "/dictionaries/:id/", to: "dictionaries#update", as: 'dictionaries_update'
